...
const Upload = () => {
  ...
  return (
    <>
      <button
        className="ml-3 inline-flex items-center pr-4 pl-2 py-2 border border-transparent rounded-md shadow-sm text-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 max-h-12"
        onClick={onOpen}
      >
